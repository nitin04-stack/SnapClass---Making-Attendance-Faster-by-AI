...
def create_student(name,face_embedding=None,voice_embedding=None):
    ...
    return response.data
def create_subject(sub_code,name,sub_section,teacher_id):
    data = {"subject_code":sub_code , "name":name,"section":sub_section,"teacher_id":teacher_id}
...
def get_student_attendance(student_id):
    response = supabase.table("attendance_log").select("*").eq("student_id",student_id).execute()
    return response.data
