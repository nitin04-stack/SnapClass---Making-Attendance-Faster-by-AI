...
@st.dialog("Review voice attendance")
def voice_attendance_dialog(selected_subject_id):
    st.write("Record audio of students saying I am Persent.Then AI will recognize the students")

    audio_data = None
    audio_data = st.audio_input("Record classroom audio..")

    if st.button("Analyse Audio",width="stretch",type = "primary"):
        with st.spinner("Preprocessing Audio data"):
